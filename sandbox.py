...
def video_edges():
    ...
    while True:
        ...
        if a == 50:
            cv2.imwrite('images/bwout.jpg', edges)
        a += 1
...
def debug():
    img = cv2.imread('images/bwout.jpg', cv2.IMREAD_GRAYSCALE)
...
def transform():
    """
    Given a hires logo file transform for training; synthetic dataset fro single hires sample

    :return:
    """
    img = cv2.imread('./images/manonhorse.jpg')
